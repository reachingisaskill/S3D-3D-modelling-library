...
int main( int, char** )
{
  testass::control::init( "S3D", "Simple Shapes (Volumes, Surfaces, etc)." );

  S3D::manager::createInstance();
  S3D::manager::getInstance()->setWorld( new S3D::box( 100.0, 100.0, 100.0, S3D::the_origin ) );
...
////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  SECTION( "Sphere" );
  {
    ...
    threeVector p2 = makeThreeVector( 1.0, 1.0, 2.0 );
    threeVector p3 = makeThreeVector( 1.0, 1.0, -8.0 );
    threeVector p4 = makeThreeVector( 1.0, 1.0, -8.000001 );
    threeVector p5 = makeThreeVector( 1.0, 11.0001, 2.0 );
    threeVector p6 = makeThreeVector( 1000.0, 0.0, 0.0 );
    threeVector p7 = makeThreeVector( 0.0, 0.0, -100.0 );
    threeVector p8 = makeThreeVector( 0.0, 0.0, -80.0 );
    threeVector p9 = makeThreeVector( 0.0, 0.0, -120.00000000001 );
    threeVector p10 = makeThreeVector( 4.765, -6.34, -90.35 );

    S3D::sphere* sph1 = S3D::addObject( new S3D::sphere( 10.0, makeThreeVector( 1.0, 1.0, 2.0 ) ) );
    S3D::sphere* sph2 = S3D::addObject( new S3D::sphere( 20.0, makeThreeVector( 0.0, 0.0, -100.0 ) ) );

    ASSERT_TRUE( sph1->contains( &p1 ) );
    ASSERT_TRUE( sph1->Contains( &p1 ) );
    ASSERT_TRUE( sph1->contains( &p2 ) );
    ASSERT_TRUE( sph1->contains( &p3 ) );
    ASSERT_FALSE( sph1->Contains( &p3 ) );
...
////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  {
    threeVector p1 = makeThreeVector( 0.0, 0.0, 0.0 );
    threeVector p2 = makeThreeVector( 0.5, 0.0, 0.0 );
    threeVector p3 = makeThreeVector( 0.0, 1.0, 0.0 );
    threeVector p4 = makeThreeVector( 0.0, 0.0, 1.5 );
    threeVector p5 = makeThreeVector( 0.5, 1.0, 1.5 );
    threeVector p6 = makeThreeVector( 100.0, 0.0, 0.0 );
    threeVector p7 = makeThreeVector( 125.0, 0.0, 0.0 );
    threeVector p8 = makeThreeVector( 125.0000001, 0.0, 0.0 );
    threeVector p9 = makeThreeVector( 100.0, 14.1421355, 14.1421355 ); // Just inside
    threeVector p10 = makeThreeVector( 100.0, 10.6066017, 10.6066017 );
    threeVector p11 = makeThreeVector( 100.0, 14.1421357, -14.1421357 ); // Just outside
    threeVector p12 = makeThreeVector( 100.0, 10.6066018, 10.6066018 );

    S3D::rotation r1( -S3D::unit_threeVector_x, 0.25*S3D::PI );

    S3D::box* b1 = S3D::addObject( new S3D::box( 1.0, 2.0, 3.0, makeThreeVector( 0.0, 0.0, 0.0 ) ) );
    S3D::box* b2 = S3D::addObject( new S3D::box( 50.0, 40.0, 30.0, makeThreeVector( 100.0, 0.0, 0.0 ), r1 ) );

    threeVector v1 = S3D::defaultDirection;
    threeVector v2 = r1 * S3D::defaultDirection;

    // Surface Centers
    ASSERT_APPROX_EQUAL( b1->surfaces()[0]->getCenter()[0], 0.5 );
    ASSERT_APPROX_EQUAL( b1->surfaces()[0]->getCenter()[1], 0.0 );
    ASSERT_APPROX_EQUAL( b1->surfaces()[0]->getCenter()[2], 0.0 );

    ASSERT_APPROX_EQUAL( b1->surfaces()[1]->getCenter()[0], -0.5 );
    ASSERT_APPROX_EQUAL( b1->surfaces()[1]->getCenter()[1], 0.0 );
    ASSERT_APPROX_EQUAL( b1->surfaces()[1]->getCenter()[2], 0.0 );

    ASSERT_APPROX_EQUAL( b1->surfaces()[2]->getCenter()[0], 0.0 );
    ASSERT_APPROX_EQUAL( b1->surfaces()[2]->getCenter()[1], 1.0 );
    ASSERT_APPROX_EQUAL( b1->surfaces()[2]->getCenter()[2], 0.0 );

    ASSERT_APPROX_EQUAL( b1->surfaces()[3]->getCenter()[0], 0.0 );
    ASSERT_APPROX_EQUAL( b1->surfaces()[3]->getCenter()[1], -1.0 );
    ASSERT_APPROX_EQUAL( b1->surfaces()[3]->getCenter()[2], 0.0 );

    ASSERT_APPROX_EQUAL( b1->surfaces()[4]->getCenter()[0], 0.0 );
    ASSERT_APPROX_EQUAL( b1->surfaces()[4]->getCenter()[1], 0.0 );
    ASSERT_APPROX_EQUAL( b1->surfaces()[4]->getCenter()[2], 1.5 );

    ASSERT_APPROX_EQUAL( b1->surfaces()[5]->getCenter()[0], 0.0 );
    ASSERT_APPROX_EQUAL( b1->surfaces()[5]->getCenter()[1], 0.0 );
    ASSERT_APPROX_EQUAL( b1->surfaces()[5]->getCenter()[2], -1.5 );


    // Directions

    ASSERT_APPROX_EQUAL( ( b2->surfaces()[0]->getCenter() - makeThreeVector( 125.0, 0.0, 0.0 ) ).mod(), 0.0 );
    ASSERT_APPROX_EQUAL( ( b2->surfaces()[1]->getCenter() - makeThreeVector( 75.0, 0.0, 0.0 ) ).mod(), 0.0 );
    ASSERT_APPROX_EQUAL( ( b2->surfaces()[2]->getCenter() - makeThreeVector( 100.0, 14.14213562, -14.14213562 ) ).mod(), 0.0 );
    ASSERT_APPROX_EQUAL( ( b2->surfaces()[3]->getCenter() - makeThreeVector( 100.0, -14.14213562, 14.14213562 ) ).mod(), 0.0 );
    ASSERT_APPROX_EQUAL( ( b2->surfaces()[4]->getCenter() - makeThreeVector( 100.0, 10.60660172, 10.60660172 ) ).mod(), 0.0 );
    ASSERT_APPROX_EQUAL( ( b2->surfaces()[5]->getCenter() - makeThreeVector( 100.0, -10.60660172, -10.60660172 ) ).mod(), 0.0 );

    ASSERT_APPROX_EQUAL( ( b2->surfaces()[0]->getDirection() - S3D::unit_threeVector_x ).mod(), 0.0 );
    ASSERT_APPROX_EQUAL( ( b2->surfaces()[1]->getDirection() + S3D::unit_threeVector_x ).mod(), 0.0 );
    ASSERT_APPROX_EQUAL( ( b2->surfaces()[2]->getDirection() - makeThreeVector( 0.0, 1.0, -1.0 ).norm() ).mod(), 0.0 );
    ASSERT_APPROX_EQUAL( ( b2->surfaces()[3]->getDirection() - makeThreeVector( 0.0, -1.0, 1.0 ).norm() ).mod(), 0.0 );
    ASSERT_APPROX_EQUAL( ( b2->surfaces()[4]->getDirection() - makeThreeVector( 0.0, 1.0, 1.0 ).norm() ).mod(), 0.0 );
    ASSERT_APPROX_EQUAL( ( b2->surfaces()[5]->getDirection() - makeThreeVector( 0.0, -1.0, -1.0 ).norm() ).mod(), 0.0 );


    ASSERT_APPROX_EQUAL( b1->getDirection()[0], v1[0] );
    ASSERT_APPROX_EQUAL( b1->getDirection()[1], v1[1] );
    ASSERT_APPROX_EQUAL( b1->getDirection()[2], v1[2] );

    ASSERT_APPROX_EQUAL( b2->getDirection()[0], v2[0] );
    ASSERT_APPROX_EQUAL( b2->getDirection()[1], v2[1] );
    ASSERT_APPROX_EQUAL( b2->getDirection()[2], v2[2] );
    ...
    ASSERT_TRUE( b1->contains( &p3 ) );
    ASSERT_TRUE( b1->contains( &p4 ) );
    ASSERT_FALSE( b1->Contains( &p2 ) );
    ASSERT_FALSE( b1->Contains( &p3 ) );
    ASSERT_FALSE( b1->Contains( &p4 ) );
    ASSERT_TRUE( b1->contains( &p5 ) ); // ERROR?
    ASSERT_FALSE( b1->Contains( &p5 ) );
    ...
    ASSERT_FALSE( b2->Contains( &p7 ) );
    ASSERT_FALSE( b2->contains( &p8 ) );
    ASSERT_TRUE( b2->contains( &p9 ) ); // ERROR?
    ASSERT_TRUE( b2->Contains( &p9 ) ); // ERROR?
